<template>
	 <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">死信队列列表</strong></div>
    </div>
	<div class="am-g">
	...
	<div class="am-g">
      <div class="am-u-sm-12">
	    <table class="am-table am-table-striped am-table-hover table-main" style="width:1000px">
	        <thead>
	             <tr>
